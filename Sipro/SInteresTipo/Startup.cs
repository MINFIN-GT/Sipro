...
namespace SInteresTipo
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            SqlMapper.SetTypeMap(typeof(InteresTipo), mapper);
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("Interés Tipo - Visualizar",
                                  policy => policy.RequireClaim("sipro/permission", "Interés Tipo - Visualizar"));
            });
