...
namespace SGantt
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("Gantt - Visualizar",
                                  policy => policy.RequireClaim("sipro/permission", "Gantt - Visualizar"));
                options.AddPolicy("Gantt - Crear",
                                  policy => policy.RequireClaim("sipro/permission", "Gantt - Crear"));
                options.AddPolicy("Gantt - Exportar",
                                  policy => policy.RequireClaim("sipro/permission", "Gantt - Exportar"));
            });
