...
namespace SComponenteTipo
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            SqlMapper.SetTypeMap(typeof(ComponenteTipo), mapper);
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("Componente Tipos - Visualizar",
                                  policy => policy.RequireClaim("sipro/permission", "Componente Tipos - Visualizar"));
                options.AddPolicy("Componente Tipos - Editar",
                                  policy => policy.RequireClaim("sipro/permission", "Componente Tipos - Editar"));
                options.AddPolicy("Componente Tipos - Eliminar",
                                  policy => policy.RequireClaim("sipro/permission", "Componente Tipos - Eliminar"));
